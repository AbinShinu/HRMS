...
const {getuser,login,adduser,deleteuser,authenticate,getUserById,addHome,gethome,profilesettings,fetchdata,deletehome,counthome,addApplication,countapplication,getPendingApplications,approveApplication,deleteApplication,getUserApplications,editHome,getAllApplications,tenanthome,countTenants,userhome} = require('../controller/userController.js')
...
userRouter.get('/api/application', getPendingApplications);
...
userRouter.get('/api/application/all/applications',getAllApplications)
userRouter.get('/api/rentedhomes/:tenantId',authenticate,tenanthome);
userRouter.get('/api/tenant/count', countTenants);
userRouter.get('/api/home/:id',authenticate,userhome);
